...
def create_and_run_instance(nodes,arcs,seed,m1,m2,m3,m4):
      ...
      """    
        ...
        if G != None:
            find_all_supported(name, G, costs, secondary_costs,  m1, m2, m3, m4, True, 'tests/tests5.csv')
...
#         for i in range(1,16):
#             G = None
#             name = 'instance_new'+ str(nodes) + '_'+str(m)+'_'+str(i)
#             G, costs, secondary_costs = netgen_random_mcfp_from_instance(i, name, nodes, 1, 10) 
#             if G != None:
#                 find_all_supported(name, G, costs, secondary_costs,  True, True, True, True, True, 'tests/tests_new_gurobi.csv')
...
#             G = None
#             name = 'instance_'+ str(nodes) + '_'+str(m)+'_'+str(i)
#             G, costs, secondary_costs = netgen_random_mcfp(nodes, i, 2, 2, m, 1, 10, 50, 0, 50, name, 1, 10)
#             if G != None:
#                 find_all_supported(name, G, costs, secondary_costs,  True, True, True, True, True, 'tests/tests5.csv')
